...
public class Application extends Throwable{
    ...
    public final ThreadPoolTaskExecutor executor = new ThreadPollExacutorConfig().getThreadPoolExecutor();
    public final String regEx = "[\\n`~!@#$%^&*()+=|{}':;',\\\\[\\\\].<>/?~！@#￥%……&*（）——+|{}【】‘；：”“’。， 、？]";

    public Application(Map<String, Object> contextMap, String savePath, String excelPath) {
